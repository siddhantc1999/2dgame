...
public class scenemanager : MonoBehaviour
{
    ...
    public int lives;
    bool isloaded = false;
    public int scenemanagercount;
    
    void Start()
    {
        totalscreens = SceneManager.sceneCountInBuildSettings;
        scenemanagercount = FindObjectsOfType<scenemanager>().Length;
        ...
        //FindObjectOfType<coinsinstantiate>().isgameover = false;
        //FindObjectOfType<coinsdestroy>().destroy = false;
        //mycoinsdestroy = FindObjectOfType<coinsdestroy>();
        //mycoinsinstantiate= FindObjectOfType<coinsinstantiate>(); ;
    ...
    void Update()
    {
        ...
        if (currentlives<=0)
        {
            ...
            // if(FindObjectOfType<coinsdestroy>().destroy)
            // {
            //     Debug.Log(FindObjectOfType<coinsdestroy>().destroy);
            // }
            //if (FindObjectOfType<coinsinstantiate>().isgameover)
            // {
            //     Debug.Log(FindObjectOfType<coinsinstantiate>().isgameover);
           ...
           if(SceneManager.GetActiveScene().buildIndex==1)
            ...
            if (FindObjectOfType<playermove>().gameObject)
            {
                GameObject playerblood = Instantiate(blood, FindObjectOfType<playermove>().transform.position,Quaternion.identity);
